 ...
 * @author Zury
 */
public class Votante_Crear extends javax.swing.JFrame {

    /**
     * Creates new form Candidato_Crear
     */
    public Votante_Crear() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRA UN VOTANTE");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       try {
             CtlVotante ctl = new CtlVotante();
                Votantes v = new Votantes();
                v.setNumeroDocumento(txtNumeroDocumento.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Votante_Crear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Votante_Crear().setVisible(true);
            }
        });
    }
